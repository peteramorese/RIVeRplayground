...
void SENSOR::plot_ekf(std::vector<double> t)
{
	...
	ttl << "Estimation Error vs Time - Sensor " << sid << endl;
...
void SENSOR::plot_e_y(std::vector<double> t)
{
	std::vector<double> x;
	std::vector<double> y;
	std::vector<double> z;
